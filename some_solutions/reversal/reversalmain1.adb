with reversal1, Ada.Text_IO;
use Ada.Text_IO;
procedure reversalmain1 is

   type T1 is array (Integer range <>) of Integer;

   procedure csere (x,y: in out Integer) is
      tmp:Integer:=x;
   begin
      x:=y;
      y:=tmp;
   ...
   procedure myreversal is new reversal1(Integer, Integer, T1, csere);
